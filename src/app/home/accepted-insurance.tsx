      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            <br />
            <br />
            If you don’t have insurance, we’ve got you covered. Our practice
            offers a variety of membership savings programs, special offers, and
            flexible financing options designed to fit your budget, making
