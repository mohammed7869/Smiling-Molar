      ...
      <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col gap-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <h2 className="text-2xl font-semibold">
              Cosmetic and Family Dentistry in Maplewood, NJ
            </h2>
            <p className="text-lg text-gray-600">
              At Tulip Dental, we are proud to offer exceptional cosmetic and
              family dentistry services near Maplewood, NJ. Led by Dr. Gurpreet
              Kaur, DDS, our experienced team is dedicated to providing
              comprehensive oral healthcare to patients of all ages. Whether
              you’re seeking preventive care, restorative solutions, or cosmetic
              enhancements, we are here to help you achieve a healthy, beautiful
              smile.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <h3 className="text-2xl font-bold">
            Comprehensive Dental Care for Maplewood Residents
          </h3>
          <p className="text-lg">
            Our state-of-the-art dental office is conveniently located near
            Maplewood, NJ, making it easy for you and your family to access
            top-quality dental care. We offer a wide range of services,
            including:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <span className="font-semibold">Emergency Dentistry</span>
              <br />
              <span className="text-gray-600">
                Same-day appointments for urgent dental issues like toothaches,
                broken teeth, and more.
              </span>
            </li>
            <li>
              <span className="font-semibold">Preventive Dentistry</span>
              <br />
              <span className="text-gray-600">
                Regular check-ups, cleanings, and oral health education to keep
                your teeth and gums healthy.
              </span>
            </li>
            <li>
              <span className="font-semibold">Cosmetic Dentistry</span>
              <br />
              <span className="text-gray-600">
                Transform your smile with veneers, teeth whitening, and
                Invisalign®.
              </span>
            </li>
            <li>
              <span className="font-semibold">Restorative Dentistry</span>
              <br />
              <span className="text-gray-600">
                Crowns, bridges, and dental implants to restore the function and
            ...
            <li>
              ...
              <br />
              <span className="text-gray-600">
                Gentle, child-friendly care to help your little ones develop
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 flex flex-col gap-4">
            <h3 className="text-2xl font-bold">
              Why Choose Tulip Dental Near Maplewood?
            </h3>
            <p className="text-lg">
              We know that finding the right dentist is crucial. Here’s why
              families in Maplewood trust Tulip Dental:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
              ...
              <li>
                ...
                <br />
                <span className="text-gray-600">
                  From digital X-rays to modern treatment techniques, we ensure
              ...
              <li>
                ...
                <br />
                <span className="text-gray-600">
                  Our office is designed to help you feel relaxed, making every
        ...
        <div className="flex flex-col items-center gap-4 text-center py-8">
          ...
          <p className="text-lg max-w-2xl">
            Tulip Dental is proud to serve the communities of Maplewood, NJ with
            high-quality, personalized dental care.
            <br />
            Ready to experience exceptional dentistry? Contact us today to
