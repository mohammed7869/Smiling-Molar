...
export default function UrvashiBanerjeeClient() {
  const doctor = {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="details-page-header-section">
        <h1>{doctor.name}</h1>
        <h2>
          Family & Cosmetic Dentist serving Maplewood, South Orange, Irvington,
          Vauxhall, and nearby Newark, NJ
        </h2>
      </div>
