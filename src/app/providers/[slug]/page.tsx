    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/providers">
            <span className="inline-block mt-2 px-4 py-2 border border-primary text-primary rounded hover:bg-primary hover:text-white transition">
              ← Back to Providers
            </span>
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="details-page-header-section">
        <h1>{doctor.name}</h1>
        <h2>
          Cosmetic and Family Dentist located in Harrisburg, Colonial Park,
          Penbrook, Paxtang, Progress, Lawnton, and Linglestown, PA
        </h2>
      </div>
