        ...
        <div className="details-page">
          ...
          <div className="details-page-desc-section">
            ...
            <div className="desc-text-section">
              ...
              <p>
                ...
                when left untreated, it can lead to tooth loss and other serious
                health concerns. At Tulip Dental in{" "}
                <Link
                ...
                , NJ, we offer Perio Protect, an innovative, non-surgical
                treatment that uses custom-fit trays to deliver medication
                directly below the gumline - where brushing and flossing can’t
                reach. This approach helps reduce harmful bacteria, improve gum
              ...
              <p>
                ...
                Searching for “gum disease treatment near me”? You’ve found a
                caring, advanced dental team ready to help restore your oral
                health.
              </p>
              {/* </Fade> */}
            </div>
            ...
            <div className="wcu-text-section">
              ...
              <div className="wcu-points-section">
                <ul className="wcu-points">
                  ...
                  <li>
                    <h3 className="service-point-title">
                      <CheckCircle className="service-point-icon" /> Custom-Fit
                      Trays for Maximum Effectiveness
                    </h3>
                  </li>
                  <li>
                    <h3 className="service-point-title">
                      <CheckCircle className="service-point-icon" /> Treats Gum
                      Disease at Home Between Visits
                    </h3>
                  </li>
                  <li>
                    <h3 className="service-point-title">
          ...
          <div className="features-section">
            ...
            <p className="features-description">
              At Tulip Dental, we believe gum care should be gentle, effective,
              and convenient. Perio Protect allows you to take control of your
              gum health with an easy-to-use system tailored to your needs.
              <br />
              <br />
          ...
          <div className="features-section">
            ...
            <p className="features-description">
              At Tulip Dental, we make gum disease treatment{" "}
              <Link
                href="/patient-reviews-maplewood-nj"
