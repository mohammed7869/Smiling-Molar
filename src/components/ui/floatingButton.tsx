...
export default function FloatingTextForm() {
  ...
  // Removed bouncing animation - keeping button static
    ...
    <div className="fixed bottom-6 right-6 z-50 pb-[env(safe-area-inset-bottom)]">
      ...
      >
        <DialogTrigger asChild>
          <button
            className="w-14 h-14 bg-primary text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-105"
            aria-label="Text us"
          >
